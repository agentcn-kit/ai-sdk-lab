...
const Home = () => {
	...
	const handleSubmit = (e?: React.FormEvent) => {
		...
		// clear input optimistically (keeps UX snappy)
		setInput("");

		// sendMessage is provided by the SDK
		sendMessage({
			text,
			// optionally include files or metadata here
		});

		// keep file inputs as-is (or clear if you want)
				...
				{isEmpty ? (
					<header className="space-y-4 text-center">
						...
						<h1 className="font-semibold text-4xl text-slate-900 sm:text-5xl">
							Chat with live <br /> streaming responses
						</h1>
