...
const Home: React.FC = () => {
  const [input, setInput] = useState("Identify my top five public repositories and update the to-do list accordingly.");
        ...
        {isEmpty ? (
          <header className="space-y-4 text-center">
            ...
            <h1 className="font-semibold text-4xl text-slate-900 sm:text-5xl">
             Manage GitHub & Files <br />to automate your workflow
            </h1>
